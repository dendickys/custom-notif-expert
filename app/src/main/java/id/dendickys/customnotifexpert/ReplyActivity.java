package id.dendickys.customnotifexpert;
...
import static id.dendickys.customnotifexpert.NotificationService.CHANNEL_ID;
import static id.dendickys.customnotifexpert.NotificationService.CHANNEL_NAME;
import static id.dendickys.customnotifexpert.NotificationService.REPLY_ACTION;
...
public class ReplyActivity extends AppCompatActivity {
    ...
    public static Intent getReplyMessageIntent(Context context, int notifyId, int messsageId) {
        Intent intent = new Intent(context, ReplyActivity.class);
        intent.setAction(REPLY_ACTION);
        intent.putExtra(KEY_MESSAGE_ID, messsageId);
    ...
    private void sendMessage(int notifyId, int messageId) {
        ...
        Toast.makeText(this, "Messsage ID: " + messageId + "\nMessage: " + message, Toast.LENGTH_SHORT).show();
